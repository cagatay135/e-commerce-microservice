...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorBody> catchInsufficientStockException(InsufficientStockException insufficientStockException) {
        return ResponseEntity.ok(ErrorBody.builder().errorCode(400).errorDescription(insufficientStockException.getMessage()).build());
    }
