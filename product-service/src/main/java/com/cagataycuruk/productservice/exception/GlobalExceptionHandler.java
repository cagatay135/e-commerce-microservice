...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorBody> catchProductNotFoundException(ProductNotFoundException productNotFoundException) {
        return ResponseEntity.ok(ErrorBody.builder().errorCode(404).errorDescription(productNotFoundException.getMessage()).build());
    }

    @ExceptionHandler(ProductCouldNotCreateException.class)
        public ResponseEntity<ErrorBody> catchProductCouldNotCreateException(ProductCouldNotCreateException productCouldNotCreateException) {
        return ResponseEntity.ok(ErrorBody.builder().errorCode(400).errorDescription(productCouldNotCreateException.getMessage()).build());
    }
